---
name: Right Step-design
description: Design system skill for Right Step. Activate when building UI components, pages, or any visual elements. Provides exact color tokens, typography scale, spacing grid, component patterns, and craft rules. Read references/DESIGN.md before writing any CSS or JSX.
---

# Right Step Design System

You are building UI for **Right Step**. Light-themed, neutral palette, sans-serif typography (sans-serif), compact density on a 4px grid, flat elevation (no shadows).
...
| Role | Token | Hex | Use |
|------|-------|-----|-----|
| Background | `--background` | `#f3f8ff` | Page/app background |
| Surface | `--surface` | `#e6f0fd` | Cards, panels, modals |
| Text Primary | `--text-primary` | `#12294b` | Headings, body text |

### Status Colors

| Status | Hex | Use |
|--------|-----|-----|
| Warning | `#f8f4e7` | Caution states, pending items |
| Danger | `#e8873a` | Errors, destructive actions |

### Extended Palette

- **color-teal-100:** `#d8ecee` — Light surface or highlight color
- **color-gold-100:** `#f2e9d0` — Light surface or highlight color
- **color-teal-500:** `#1596a0`
- **color-gold-400:** `#c9a227`
- **color-navy-200:** `#d1e2fa` — Light surface or highlight color
- **color-navy-300:** `#b5cef3`
- **color-navy-400:** `#8eb1e5`
- **color-navy-500:** `#6d96d3`
...
- Styles: `bg-gold-50`, `rounded-xl`, `gap-3.5`, `text-gold-ink`

**AuthShell** (`src/components/AuthShell.tsx`)
- Styles: `bg-surface`, `border-t`, `pt-[72px]`, `text-[2rem]`, `opacity-70`

**CheckoutClient** (`src/components/CheckoutClient.tsx`)
- Variants: `card`, `wallet`, `idle`, `working`, `bank`, `blocked`
- Styles: `bg-surface`, `rounded-xl`, `pt-[72px]`, `text-sm`, `shadow-[var(--shadow-step)]`

**ClientStrip** (`src/components/ClientStrip.tsx`)
- Styles: `bg-surface`, `border-b`, `py-10`, `text-center`

**ContactForm** (`src/components/ContactForm.tsx`)
- Variants: `idle`, `sending`, `sent`
- Styles: `bg-teal-50`, `rounded-2xl`, `gap-4`, `text-white`, `shadow-[var(--shadow-step)]`

**CtaBand** (`src/components/CtaBand.tsx`)
- Styles: `bg-surface`, `rounded-3xl`, `pb-20`, `text-white`, `opacity-60`

**Field** (`src/components/Field.tsx`)
- Styles: `rounded-e-xl`, `gap-2`, `text-sm`

**Footer** (`src/components/Footer.tsx`)
- Styles: `bg-navy-deep`, `rounded-xl`, `gap-10`, `text-white`

**ForgotForm** (`src/components/ForgotForm.tsx`)
- Variants: `idle`, `working`, `sent`
- Styles: `bg-teal-50`, `rounded-2xl`, `gap-4`, `text-white`, `shadow-[var(--shadow-cta)]`

**Header** (`src/components/Header.tsx`)
- Styles: `bg-white`, `border-t`, `gap-4`, `text-base`
...
- **Duration scale:** `850ms`
- **Easing functions:** `ease`
- **Animated properties:** `transform`

### Motion Guidelines

- **Duration:** Use values from the duration scale above. Short (850ms) for micro-interactions, long (850ms) for page transitions
...
- **No arbitrary border-radius** — use the scale: 4px, 8px, 12px, 16px, 24px
...
- Creating new components, pages, or visual elements for Right Step
- Writing CSS, Tailwind classes, styled-components, or inline styles
- Building page layouts, templates, or responsive designs
- Reviewing UI code for design consistency
- The user mentions "Right Step" design, style, UI, or theme
